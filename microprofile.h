...
"	var fOffsetY = -nOffsetY + BoxHeight;\n"
"\n"
"	if(DetailedRedrawState.fOffsetY == fOffsetY && DetailedRedrawState.fDetailedOffset == fDetailedOffset && DetailedRedrawState.fDetailedRange == fDetailedRange && !MouseZoom && !MouseDragKey && !MouseDragButton)\n"
"	{\n"
"		Invalidate++;\n"
"	}\n"
"	else\n"
...
"	}\n"
"\n"
"	if(MouseDragKey || MouseZoom || MouseDragButton)\n"
"	{\n"
"		nHoverToken = -1;\n"
"		nHoverTokenIndex = -1;\n"
...
"	{\n"
"		if(ProfileMode == 2 || ((nHoverCSCpu >= 0 || nHoverToken != -1) && !MouseZoom && !MouseDragKey && !MouseDragButton)||(Invalidate<2 && !MouseZoom && !MouseDragKey && !MouseDragButton))\n"
"		{\n"
"			Draw(1);\n"
"		}\n"
"	}\n"
...
"}\n"
"\n"
"function MouseUpdateDrag(bPressed, evt)\n"
"{\n"
"   if(bPressed && (evt.button == 1 || evt.which == 1))\n"
"    {\n"
"    	\n"
"		MouseDragButton = 1;\n"
"    }\n"
...
"		if(Mode == ModeDetailed)\n"
"		{\n"
"		    if(MouseDragKey || MouseDragButton)\n"
"			{\n"
