...
"    <ul id=\"GroupSubMenu\">\n"
"        <li><a href=\"#\" onclick=\"MicroProfileToggleGroup();\">All</a></li>\n"
"        <li><a href=\"#\">---</a></li>\n"
"    </ul>\n"
"</li>\n"
...
"\n"
"\n"
"function MicroProfileInitFrameInfo()\n"
"{\n"
"	var DetailedTotal = 0;\n"
...
"\n"
"\n"
"function MicroProfileInitGroupMenu()\n"
"{\n"
...
"		li.innerText = name;\n"
"		var asText = li.innerHTML;\n"
"		var html = \'<a href=\"#\" onclick=\"MicroProfileToggleGroup(\\'\' + name + \'\\');\">\' + asText + \'</a>\';\n"
"		li.innerHTML = html;\n"
...
"		Lis[i].style[\'width\'] = LenStr;\n"
"	}\n"
"	MicroProfileUpdateGroupMenu();\n"
"}\n"
"\n"
"function MicroProfileUpdateGroupMenu()\n"
"{\n"
...
"\n"
"\n"
"function MicroProfileToggleGroup(GroupName)\n"
"{\n"
"	if(GroupName)\n"
"	{\n"
...
"\n"
"}\n"
"function MicroProfileCalculateTimers(Result, TimerIndex, nFrameFirst, nFrameLast)\n"
"{\n"
...
"}\n"
"\n"
"function MicroProfileDrawDetailedFrameHistory()\n"
"{\n"
...
"\n"
"		MicroProfileDrawToolTip(StringArray, CanvasHistory, HistoryViewMouseX, HistoryViewMouseY+20);\n"
"\n"
"	}\n"
"\n"
"}\n"
...
"		context.fillStyle = nMicroProfileBackColors[nColorIndex];\n"
...
"\n"
"\n"
"function MicroProfileZoomGraph(nZoom)\n"
"{\n"
...
"			if(evt.button == 0)\n"
"			{\n"
"				MicroProfileZoomTo(fRangeBegin, fRangeEnd);\n"
"			}\n"
"		}\n"
"	}\n"
...
"{\n"
"	var v = MicroProfileCalculateTimers(TimerInfo[i], i);\n"
"\n"
"}\n"
"var end = new Date();\n"
"var time = end - start;\n"
...
"MicroProfileInitGroupMenu();\n"
"MicroProfileInitFrameInfo();\n"
"MicroProfileUpdateThreadMenu();\n"
"\n"
"ResizeCanvas();\n"
"MicroProfileDraw();\n"
