...
"\n"
"}\n"
"function ToggleTimersTimers()\n"
"{\n"
"	TimersTimers = TimersTimers ? 0 : 1;\n"
"	WriteCookie();\n"
"	UpdateTimersOptions();\n"
"	Invalidate = 0;\n"
"}\n"
"function ToggleTimersGroups()\n"
"{\n"
"	TimersGroups = TimersGroups ? 0 : 1;\n"
"	WriteCookie();\n"
"	UpdateTimersOptions();\n"
"	Invalidate = 0;\n"
"}\n"
...
"	var fOffsetY = -nOffsetY + BoxHeight;\n"
"\n"
"	if(DetailedRedrawState.fOffsetY == fOffsetY && DetailedRedrawState.fDetailedOffset == fDetailedOffset && DetailedRedrawState.fDetailedRange == fDetailedRange && !MouseZoom && !MouseDrag)\n"
"	{\n"
"		Invalidate++;\n"
"	}\n"
"	else\n"
...
"	{\n"
"		if(ProfileMode == 2 || ((nHoverCSCpu >= 0 || nHoverToken != -1) && !MouseZoom && !MouseDrag)||(Invalidate<2 && !MouseZoom && !MouseDrag))\n"
"		{\n"
"			Draw(1);\n"
"		}\n"
"	}\n"
