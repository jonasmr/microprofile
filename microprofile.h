...
"var CSwitchColors = [\'#63607B\',\'#755E2B\',\'#326A55\',\'#523135\',\'#904F42\',\'#87536B\',\'#346875\',\'#5E6046\',\'#35404C\',\'#224038\',\'#413D1E\',\'#5E3A26\',\'#5D6161\',\'#4C6234\',\'#7D564F\',\'#5C4352\'];\n"
"var CSwitchHeight = 5;\n"
...
"		}\n"
"		DrawToolTip(StringArray, Canvas, 0, 400);\n"
"	}\n"
"}\n"
"\n"
...
"\n"
"\n"
"function DrawContextSwitchBars(context, ThreadId, fScaleX, fOffsetY, fDetailedOffset, nHoverColor)\n"
"{\n"
...
"		console.log(timeTaken + \' for \' + ThreadId);\n"
"\n"
"\n"
"	}\n"
"	if(CSObject)\n"
...
"								var IndexStart = Frames[LocalFirstFrame].LogStart[nLog];\n"
"								var IndexEnd = g_TimeArray[nLog].length;\n"
"								// /console.log(\"range \" + IndexStart + \" \" + IndexEnd);\n"
"\n"
...
"	{\n"
"		if(ProfileMode == 2 || ((nHoverCSCpu >= 0 || nHoverToken != -1) && !MouseZoom && !MouseDrag))\n"
"		{\n"
"			Draw(1);\n"
"		}\n"
"	}\n"
...
"function CreateLod(index, MinDelta, TimeArray, TypeArray, IndexArray, LogStart)\n"
"{\n"
"	if(LodData[index])\n"
"	{\n"
"		console.log(\"error!!\");\n"
...
"			}\n"
"			\n"
"			console.log(\"split \" + SplitIndex + \" Time \" +SplitArray[j]);\n"
"		}\n"
...
"				{\n"
"					StackPos--;\n"
"					var Duration = Stack[StackPos] - time;\n"
...
"\n"
"		}\n"
"		CreateLod(i+1, MinDelta, TimeArray, TypeArray, IndexArray, DestLogStart);\n"
"	}\n"
"	ProfileLeave();\n"
"}\n"
...
"	}\n"
"	CreateLod(0, 0, g_TimeArray, g_TypeArray, g_IndexArray, LogStartArray);\n"
"	ProfileLeave();\n"
"}\n"
"\n"
