...
"        <li><a href=\"#\" onclick=\"ToggleDrawMode();\">FastDraw</a></li>\n"
...
"var Debug = 0;\n"
"var DrawModeDefault = 0;\n"
"var DrawModeFast = 1;\n"
"var DrawMode = DrawModeFast;\n"
...
"	}\n"
"\n"
"	var nMinTimeMs = nMinWidth / fScaleX;\n"
"	if(DrawMode == DrawModeFast)\n"
"	{\n"
"		// console.log(\"min time is \" + nMinTimeMs);\n"
"\n"
