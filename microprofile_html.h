...
"	var Y = SizeInfo.y;\n"
"	var X = SizeInfo.x;\n"
"	var YText = Y + BoxHeight - FontAscent;\n"
"	var SizeMinus = context.measureText(\'-\').width;\n"
"	var SizePlus = context.measureText(\'+\').width;\n"
"\n"
"	function DrawMenuElement(Selected, Name, Value, color)\n"
"	{\n"
...
"		context.fillStyle = color;\n"
"		context.fillText(Name, X, YText);\n"
"		context.textAlign = \'right\';\n"
"		context.fillText(\'\' + Value, X + Width-2, YText);\n"
"		context.textAlign = \'left\';\n"
"		nColorIndex = 1-nColorIndex;\n"
"		Y += BoxHeight;\n"
"		YText += BoxHeight;\n"
...
"	}\n"
"	function DrawMenuRoll(Name, RollValue, RollExt, RollFunction, Tweak)\n"
"	{\n"
"		var bMouseIn = MouseY >= Y && MouseY < Y + BoxHeight;\n"
"		var bgcolor = bMouseIn ? nBackColorOffset : nBackColors[nColorIndex];\n"
"		context.fillStyle = bgcolor;\n"
...
"		YText += BoxHeight;\n"
"\n"
"		if(MouseReleased && bMouseIn && !MouseReleasedUsed)\n"
"		{\n"
"			var V = ShowPrompt(Name, RollValue);\n"
"			RollFunction(0,0,V);\n"
"		}\n"
"		return Tweak;\n"
"	\n"
"	}\n"
"	context.fillRect(X, Y, Width, SizeInfo.h);\n"
"	if(DrawMenuElement(0, \"AutoCapture Enabled\", AutoCaptureEnabled ? \"on\" : \"off\", \'white\', 0))\n"
"	{\n"
"		AutoCaptureEnabled = !AutoCaptureEnabled;\n"
"	}\n"
"	AutoCaptureSourceTweak = DrawMenuRoll(\"AutoCapture Source\", GetAutoCaptureString(), \'\', AutoCaptureSourceRoll, AutoCaptureSourceTweak);\n"
"	AutoCaptureTweak = DrawMenuRoll(\"AutoCapture Threshold\", AutoCaptureTheshold, \'ms\', AutoCaptureRoll, AutoCaptureTweak );\n"
"	CaptureTweak = DrawMenuRoll(\"Capture Length\",  CaptureFrames, \'\', CaptureRoll, CaptureTweak);\n"
"\n"
