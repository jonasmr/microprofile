...
"}\n"
"\n"
"function DrawDetailedView(context, ";

const size_t g_MicroProfileHtml_end_1_size = sizeof(g_MicroProfileHtml_end_1);
const char g_MicroProfileHtml_end_2[] =
"MinWidth, bDrawEnabled)\n"
"{\n"
"	if(bDrawEnabled)\n"
"	{\n"
...
"function KeyUp(evt)\n"
"{\n"
"	if(FilterSearchActive != 0)\n"
"	{\n"
"		// index is into implicit list, doesnt work\n"
"		// if(evt.keyCode == 38)\n"
"		// {\n"
...
"\n"
"//todo\n"
"//default load on start does not work.. settings default load doesn\'t enable timers..\n"
"//strict in normal\n"
...
"var FormatCounterBytesExt = [ \"b\",\"kb\",\"mb\",\"gb\",\"tb\",\"pb\", \"eb\",\"zb\", \"yb\" ];\n"
"\n"
"var BarColumnNames = [StrAverage, StrMax, StrTotal, StrMin, StrSpike, StrCallAverage, StrCount, StrExclAverage, StrExclMax];\n"
"Settings.BarColumnsEnabled = new Array(BarColumnNames.length);\n"
"var ColumnsWidth = new Array(BarColumnNames.length);\n"
"\n"
"for(var i = 0; i < Settings.BarColumnsEnabled.length; ++i)\n"
"{\n"
"	Settings.BarColumnsEnabled[i] = 1;\n"
"	ColumnsWidth[i] = 10;\n"
"}\n"
"\n"
"\n"
...
"	function DrawHeaderSplit(Header)\n"
"	{\n"
"		if(Settings.BarColumnsEnabled[R])\n"
"		{\n"
"			context.fillStyle = \'white\';\n"
"			context.fillText(HeaderString(Header), X, Height-FontAscent);\n"
"			var XBegin = X;\n"
...
"{\n"
"	return MouseX >= X && MouseX <= X + W && MouseY >= Y && Mouse";
...
"	{\n"
"		Y -= 60;\n"
"		context.fillText(\"Paused: Enable groups in \'Control\' menu to unpause\", X, Y);\n"
"	}\n"
"	if(TimersEnabled == 0)\n"
"	{\n"
"		Y -= 60;\n"
"		context.fillText(\"Select Timers in \'Timers\' menu\", X, Y);\n"
"	}\n"
"	context.textAlign = \'left\';\n"
"	context.font = Font;\n"
"}\n"
...
"\n"
"\n"
"function OnLoadPreset(NewSettings, Apply)\n"
"{\n"
"	WSSendMessage(\"d\");\n"
...
"	{\n"
"		var Active = ActivePreset == Presets[i] ? 1 : 0;\n"
"		if(DrawMenuElement(M, Settings.BarColumnsEnabled[i], BarColumnNames[i], \"\", \'white\', 0))\n"
"		{\n"
"			Settings.BarColumnsEnabled[i] = !Settings.BarColumnsEnabled[i];\n"
"			for(var i = 0; i < ColumnsWidth.length; ++i)\n"
"			{\n"
"				ColumnsWidth[i] = 20;\n"
"			}\n"
...
"function ToggleView()\n"
"{\n"
"	Settings.ViewActive = (Settings.ViewActive+1) % 4;\n"
"	ActivateView(Settings.ViewActive);\n"
"}\n"
"\n"
...
"ax(CounterNameWidth, (TimerArray[idx].name.length + 1 + TimerArray[idx].depth) * (FontWidth+1));\n"
...
"		// console.log(\'counter \' + idx  + \' parent \' + pidx );\n"
"	}\n"
"	// console.log(\"add timer \" + idx + \" json: \" + JSON.stringify(TimerArray[idx]));\n"
"	RequestDraw();\n"
"}\n"
"\n"
...
"			if(0 == FrameData.Frozen[i])\n"
"			{\n"
"				GraphTimeMax = GraphTimeMax > A[i] ? GraphTimeMax : A[i];\n"
"			}\n"
"		}\n"
"	}\n"
...
"	{\n"
"		OnLoadPreset(Obj.v, 1);\n"
"	}\n"
"	else if(k == MSG_CURRENTSETTINGS)\n"
"	{\n"
"		OnLoadPreset(Obj.v, 0);\n"
"	}\n"
