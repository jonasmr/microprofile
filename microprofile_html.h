...
"		<li id=\'DrawDetailedScaleMode\'><a href=\"javascript:void(0)\" onclick=\"ToggleDetailedScaleMode();\">Offset Mode</a></li>\n"
...
"	}\n"
"}\n"
"function ToggleDetailedScaleMode()\n"
"{\n"
"	RequestRedraw();\n"
"	DrawDetailedScaleMode = (DrawDetailedScaleMode+1)%3;\n"
"}\n"
...
"illStyle = CSwitchColors[ActiveCpu % nNumColors];\n"
"					}\n"
...
"	if(DrawDetailedScaleMode == 1)\n"
"		BoxHeightScaled = Math.ceil(BoxHeight*0.5);\n"
"	else if(DrawDetailedScaleMode == 2)\n"
"		BoxHeightScaled = 0;\n"
"	var Levels = [];\n"
...
"							var timeend = time;\n"
"							var X = (timestart - fDetailedOffset) * fScaleX;\n"
"							var Y = fOffsetY + StackPos * BoxHeightScaled;\n"
"							var W = (timeend-timestart)*fScaleX;\n"
"\n"
...
"										cid = cidhovercolor;\n"
"									}\n"
"									AddBatch(StackPos, cid, X, Y, W, TimerInfo[index].name, TimerInfo[index].len, timeend-timestart);\n"
"								}\n"
"\n"
...
"					}\n"
"				}\n"
"				fOffsetY += (g_MaxStack[nLog]) * BoxHeightScaled + BoxHeight;\n"
"\n"
"				if(HasSetHover)\n"
"				{\n"
...
"		}\n"
"		if(Obj.DrawDetailedScaleMode)\n"
"		{\n"
"			DrawDetailedScaleMode = Obj.DrawDetailedScaleMode;\n"
"		}\n"
...
"	Obj.DrawDetailedScaleMode = DrawDetailedScaleMode;\n"
"	if(nHideHelp)\n"
"	{\n"
"		Obj.nHideHelp = 1;\n"
"	}\n"
