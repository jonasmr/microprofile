...
"				if(nContextSwitchEnabled)\n"
"				{\n"
"					DrawContextSwitchBars(context, S.ThreadIds[nLog], fScaleX, OY, Off, nHoverColor, MinWidth, bDrawEnabled);\n"
...
"		var CallExclAverage = FD.TimeCallExclAvg[AggregateIndex];\n"
...
"		context.fillRect(0, Y, Width, FontHeight+2);\n"
"\n"
"		DrawTimer(Time, Timer.color);\n"
"		DrawTimer(Excl, Timer.color);\n"
"\n"
...
"		DrawTimer(ExclusiveTotal, Timer.color);\n"
"\n"
"		DrawCount(Spike.toFixed(2) + \'%\');\n"
"		DrawTimer(CallAverage,Timer.color);\n"
"		DrawTimer(CallExclAverage,Timer.color);\n"
"		DrawCount(\'\' + CallCount);\n"
"\n"
"		context.fillStyle = bMouseIn ? nBackColorOffset : nBackColors[nColorIndex];\n"
"		context.fillRect(0, Y, NameWidth, Height);\n"
"		if(Timer.idtype == TYPE_GROUP)\n"
"		{\n"
"			context.textAlign = \'left\';\n"
"			context.fillStyle = Timer.color;\n"
"			context.fillText(Timer.name, 1, YText);\n"
"		}\n"
"		else\n"
"		{\n"
"			context.textAlign = \'right\';\n"
...
"			switch(Settings.SortColumn)\n"
"			{\n"
"				case 1: KeyFunc = function (a) { return TimerArray[a].time; }; break;\n"
"				case 2: KeyFunc = function (a) { return TimerArray[a].excl; }; break;\n"
"				//aggregate\n"
"				case 3: KeyFunc = function (a) { return TimerArray[a].average; }; break;\n"
"				case 4: KeyFunc = function (a) { return TimerArray[a].max; }; break;\n"
"				case 5: KeyFunc = function (a) { return TimerArray[a].min; }; break;\n"
"				case 6: KeyFunc = function (a) { return TimerArray[a].total; }; break;\n"
"				case 7: KeyFunc = function (a) { return TimerArray[a].exclaverage; }; break;\n"
"				case 8: KeyFunc = function (a) { return TimerArray[a].exclmax; }; break;\n"
"				case 9: KeyFunc = function (a) { return TimerArray[a].excltotal; }; break;\n"
"				case 10: KeyFunc = function (a) { return TimerArray[a].spike; }; break;\n"
"				//call aggregate\n"
"				case 11: KeyFunc = function (a) { return TimerArray[a].callaverage; }; break;\n"
"				case 12: KeyFunc = function (a) { return TimerArray[a].callexclaverage; }; break;\n"
"				case 13: KeyFunc = function (a) { return TimerArray[a].callcount; }; break;\n"
"			}\n"
"			var Flip = Settings.SortColumnOrderFlip == 1 ? -1 : 1;\n"
"			OrderArray.sort(function(a,b) { return Flip * (KeyFunc(b) - KeyFunc(a)); } );\n"
"		}\n"
...
"		}\n"
"		let UpdateFrameDataInternal = function(id, Time, TimeExcl, Count)\n"
"		{\n"
...
"			groups[id] = 1;\n"
"			var t = F.g[i];\n"
"			UpdateFrameDataInternal(id, t[0], t[1], t[2]);\n"
"		}\n"
"\n"
