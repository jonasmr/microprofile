...
"		if(!ThreadY)\n"
"		{\n"
"			ThreadY = new Array(S.ThreadNames.length+1);\n"
"		}\n"
"\n"
"		for(nLog = 0; nLog < nNumLogs; nLog++)\n"
"		{\n"
"			var ThreadName = S.ThreadNames[nLog];\n"
...
"				{\n"
"					DrawContextSwitchBars(context, S.ThreadIds[nLog], fScaleX, fOffsetY, fDetailedOffset, nHoverColor, MinWidth, bDrawEnabled);\n"
