...
"var AutoCaptureTheshold = AutoCaptureDefaultThreshold;\n"
...
"var CaptureFrames = CaptureFramesDefault;\n"
...
"	var BarTimes = [];\n"
"	var BarColors = [];\n"
"	var AggregateIndex = ReferenceTime < 0 ? AggregateHistorySize-1 : AggregateHistorySize-2; //fix med \n"
"	var GetTime = null;\n"
"\n"
...
"{\n"
"\n"
"	var CaptureText = \"Capture[\" + CaptureFrames + \"]\";\n"
...
"function Capture()\n"
"{\n"
"	var url = \'http://\' + WSHost + \':\' + WSPort + \'/\' + CaptureFrames;\n"
"	window.open(url);\n"
"}\n"
"function InitMenu()\n"
"{\n"
...
"	return DrawMenuGeneric(ViewNames, ViewActive, ViewClick, x, y);\n"
"}\n"
"\n"
...
"	if(SetDirect)\n"
"	{\n"
"		AutoCaptureTheshold = SetDirect;\n"
"	}\n"
"	else if(Tweak)\n"
"	{\n"
"		AutoCaptureTheshold = TweakValue(AutoCaptureTheshold, Tweak, 0.98, 1, 500);\n"
"	}\n"
"	else if(Direction)\n"
"	{\n"
"		AutoCaptureTheshold = NextValue(AutoCaptureThesholdPresets, AutoCaptureTheshold, Direction);\n"
"	}\n"
"}\n"
"\n"
...
"	if(SetDirect)\n"
"	{\n"
"		CaptureFrames = SetDirect;\n"
"	}\n"
"	else if(Tweak)\n"
"	{\n"
"		CaptureFrames = TweakValue(CaptureFrames, Tweak, 0.98, 5, 300);\n"
"\n"
"	}\n"
"	else if(Direction)\n"
"	{\n"
"		CaptureFrames = NextValue(CaptureFramesPresets, CaptureFrames, Direction);\n"
"	}\n"
"}\n"
...
"	AutoCaptureTweak = DrawMenuRoll(M, \"AutoCapture Threshold\", AutoCaptureTheshold, \'ms\', AutoCaptureRoll, AutoCaptureTweak, \'int\');\n"
"	CaptureTweak = DrawMenuRoll(M, \"Capture Length\",  CaptureFrames, \'\', CaptureRoll, CaptureTweak, \'int\');\n"
"\n"
...
"	if(SetDirect)\n"
"	{\n"
"		AggregateFrames = SetDirect;\n"
"	}\n"
"	else if(Tweak)\n"
"	{\n"
"		AggregateFrames = TweakValue(AggregateFrames, Tweak, 0.98, 0, 500);\n"
"\n"
"	}\n"
"	else if(Direction)\n"
"	{\n"
"		AggregateFrames = NextValue(AggregatePresets, AggregateFrames, Direction);\n"
"	}\n"
"}\n"
...
"	if(SetDirect)\n"
"	{\n"
"		ReferenceTime = SetDirect;\n"
"	}\n"
"	else if(Tweak)\n"
"	{\n"
"		ReferenceTime = TweakValue(ReferenceTime, Tweak, 0.98, 5, 1000);\n"
"\n"
"	}\n"
"	else if(Direction)\n"
"	{\n"
"		ReferenceTime = NextValue(ReferencePresets, ReferenceTime, Direction);\n"
"	}\n"
"}\n"
...
"	if(SetDirect)\n"
"	{\n"
"		TargetTime = SetDirect;\n"
"	}\n"
"	else if(Tweak)\n"
"	{\n"
"		TargetTime = TweakValue(TargetTime, Tweak, 0.98, 5, 1000);\n"
"\n"
"	}\n"
"	else if(Direction)\n"
"	{\n"
"		TargetTime = NextValue(ReferencePresets, TargetTime, Direction);\n"
"	}\n"
"}\n"
"\n"
...
"	ReferenceTimeTweak = DrawMenuRoll(M, \"Reference Time\", ReferenceTime, \'\', ReferenceRoll, ReferenceTimeTweak, \'int\');\n"
"	TargetTimeTweak = DrawMenuRoll(M, \"Target Time\", TargetTime, \'\', TargetRoll, TargetTimeTweak, \'int\');\n"
"	// var Y = SizeInfo.y;\n"
...
"	// 	var bgcolor = bMouseIn ? nBackColorOffs";
...
"	if(AutoCapture)\n"
"	{\n"
"		if(AutoCaptureSourceIndex == -1 && F.t > AutoCaptureTheshold)\n"
"		{\n"
"			TriggerAutoCapture = 1;\n"
"			console.log(\'trigger capture! \', F.t, \' \', AutoCaptureTheshold);\n"
"		}\n"
...
"			if(Data && Data[0])\n"
"			{\n"
"			 	if(Data[0] > AutoCaptureTheshold)\n"
"			 	{\n"
"			 		TriggerAutoCapture = 1;\n"
"					console.log(\'trigger capture! \', Data[0], \' \', AutoCaptureTheshold);\n"
"			 	}\n"
"			}\n"
"		}\n"
"	}\n"
...
"\n"
"		if(FD.Aggregate > AggregateFrames)\n"
"		{\n"
"			FD.Aggregate = 0;\n"
"			FD.AggregateSum = 0;\n"
"			FD.AggregateMax = 0;\n"
