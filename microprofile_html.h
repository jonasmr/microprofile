...
"\n"
"//improvements:\n"
"//optimize websocket client perf\n"
"\n"
"\n"
"\n"
"\n"
...
"		var Average = Timer.TimeAvg;\n"
"		var Max = Timer.TimeMax;\n"
"		var Min = Timer.TimeMin;\n"
"		//var Spike = Timer.;\n"
"		var ExclusiveMax = Timer.TimeExclMax;\n"
"		var ExclusiveAverage = Timer.TimeExclAvg;\n"
"		// var CallAverage = Timer.callaverage;\n"
"		// var CallCount = Timer.callcount;\n"
"		var YText = Y+Height-FontAscent;\n"
"		X = NameWidth + XBase;\n"
...
"		context.textAlign = \'left\';\n"
"		context.fillStyle = \'white\';\n"
"		context.fillText(\"groupname\", 1, YText);\n"
"	}\n"
"	function FilterMatch(FilterArray, value)\n"
"	{\n"
"		if(!FilterArray)\n"
