...
"				}\n"
"				if(DetailedViewMouseX >= X && DetailedViewMouseX <= X+W && DetailedViewMouseY < fOffsetY+CSwitchHeight && DetailedViewMou";
...
"		// var ColorsText = Timeline.ColorsText;\n"
"		// var ColorsDark = Timeline.ColorsDark;\n"
...
"	// Timeline.ColorsDark = new Array(TimelineArray.length);\n"
"	// Timeline.ColorsText = new Array(TimelineArray.length);\n"
...
"		console.log(\'got color \' + Timeline.Colors[i]);\n"
"		if(null == Timeline.Colors[i])\n"
"			debugger;\n"
"		Timeline.Colors[i] = GetColorIndex(Color);\n"
"		console.log(\'got color2 \' + Timeline.Colors[i]);\n"
"	}\n"
"\n"
"\n"
