...
"	var fDetailedOffsetEnd = fDetailedOffse";
...
"ileEnter(\"PreprocessContextSwitchCache\");\n"
"	var AllThreads = {};\n"
"	var nCount = S.CSwitchTime.length;\n"
"	for(var i = 0; i < nCount; ++i)\n"
"	{	\n"
...
"					if(MouseReleased)\n"
"					{\n"
"						ThreadsActive[ThreadName] = !ThreadsActive[ThreadName];\n"
"						RequestRedraw();\n"
"					}					\n"
"				}\n"
...
"\n"
"					// DrawDetailedButtons(context, nWidth, fOffsetY+1, [\"\\u2191\\u2191\\u2191\", \"\\u2193\\u2193\\u2193\"], \n"
"					// 	[ThreadOrderMoveUp, ThreadOrderMoveDown],\n"
"					// 	 \"right\");\n"
"					if(MouseReleased)\n"
"					{\n"
"						ThreadsActive[ThreadName] = !ThreadsActive[ThreadName];\n"
...
"	{\n"
"		let Colors = GroupColors ? \"Color[group]\" : \"Color[timer]\";\n"
...
"{\n"
"	var GroupRemapReverse = Array(S0.GroupInfo.length);\n"
...
"	let CompStr = \'Compare [\' + document.getElementById(\'file-input\').value + \']\';\n"
