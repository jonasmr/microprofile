...
"	var TimerLen = 6;\n"
"	var TimerWidth = TimerLen * FontWidth;\n"
"	var CounterNameWidth = 130;\n"
"	nHoverCounter = -1;\n"
"	function CounterIndent(Level)\n"
"	{\n"
"		return Level * 4 * FontWidth;\n"
"	}\n"
"	function CalcCounterWidthRecursive(Index)\n"
"	{\n"
"		var Counter = CounterInfo[Index];\n"
"		var Width = CounterIndent(Counter.level) + (1+Counter.name.length) * (FontWidth+1);\n"
"		CounterNameWidth = Width > CounterNameWidth ? Width : CounterNameWidth;\n"
"		if(!Counter.closed)\n"
"		{\n"
"			var ChildIndex = Counter.firstchild;\n"
"			while(ChildIndex != -1)\n"
"			{\n"
"				CalcCounterWidthRecursive(ChildIndex);\n"
...
"		context.fillText(c + Counter.name, CounterIndent(Counter.level), Y+Height-FontAscent);\n"
"		X += CounterNameWidth;		\n"
...
"	DrawHeaderSplitSingleRight(\'Value\', CounterWidth);\n"
"\n"
"	ProfileLeave();\n"
"}\n"
"\n"
