...
"ntext.fillStyle = nBackColorOffset;\n"
"	context.fillRect(0, 0, Width, Height);\n"
"	context.fillStyle = \'white\';\n"
"	SortColumnMouseOverNext = null;\n"
"	X = NameWidth + XBase;\n"
...
"var SubMenuSettings = 3;\n"
"var SubMenuViews = 4;\n"
"var SubMenuPresets = 5;\n"
"var SubMenuColumns = 6;\n"
"var SubMenuCapture = 7;\n"
"var SubMenuActive = -1;\n"
...
"	}\n"
"\n"
"	if(SubMenuActive == SubMenuTimers || SubMenuActive == SubMenuGroup || SubMenuActive == SubMenuFunctions)\n"
"	{\n"
"		FilterInputDiv.style[\'display\'] = \'inline\';\n"
"		FilterInput.focus();\n"
"	}\n"
...
"		Spinner.Canvas.width = w;\n"
"		Spinner.Canvas.height = h;\n"
"		Spinner.Canvas.getContext(\'2d\').scale(1, 1);\n"
"		Spinner.CanvasBack.style.width = w + \'px\';\n"
"		Spinner.CanvasBack.style.height = h + \'px\';\n"
"		Spinner.CanvasBack.width = w;\n"
"		Spinner.CanvasBack.height = h;\n"
"		Spinner.CanvasBack.getContext(\'2d\').scale(1, 1);\n"
"		Spinner.CanvasH = h;\n"
"		Spinner.CanvasW = w;\n"
...
"	Spinner.CanvasDPR = -1;\n"
"	Spinner.Circles = [];\n"
"	Spinner.Circles.push(SpinnerCircle(1 / 4, 0, 0, 0, 0 / 1.13, 0));\n"
"	Spinner.Fade = 0;\n"
"	return Spinner;\n"
"}\n"
"\n"
"var SpinnerLarge = SpinnerInit();\n"
"var SpinnerLarge2 = SpinnerInit();\n"
"var SpinnerSmall = SpinnerInit();\n"
"var SpinnerSmall2 = SpinnerInit();\n"
...
"	if(Spinner.Fade <= 0)\n"
"		return;\n"
"	ContextSpinner.clearRect(0, 0, 400, 400);\n"
"	ContextSpinner.globalAlpha = 0.90;\n"
"	ContextSpinner.drawImage(Spinner.CanvasBack, 0, 0);\n"
"	ContextSpinner.globalAlpha = 1.0;\n"
"	var twopi = 2 * Math.PI;\n"
"	for(var i = 0; i < Spinner.Circles.length; ++i)\n"
"	{\n"
"		var C = Spinner.Circles[i];\n"
"		InitCircle();\n"
"		var xs = CircleX;\n"
"		var ys = CircleY;\n"
"		var scale = (w-2) / 2;\n"
...
"			ys[i] += offset;\n"
"		}\n"
"		ContextSpinner.strokeStyle = \'white\';\n"
...
"	context.drawImage(Spinner.Canvas, X, Y);\n"
"	context.globalAlpha = 1;\n"
...
"		context.fillText(SymbolStateString, X + 50, TextY);\n"
"	}\n"
"	SpinnerDraw(0 == SymbolButtonActive, context, SpinnerSmall2, X+2, Y,  FontHeight, FontHeight );\n"
"\n"
"	Y += BoxHeight;\n"
...
"					bgcolor = bMouseIn ? nBackColorOffset : nBackColors[nColorIndex];\n"
"					TextY = Y+BoxHeight-FontAscent;\n"
"					context.fillStyle = E?\'white\':\'grey\';\n"
"					context.fillRect(X-2, Y, Width+4, BoxHeight);\n"
"					context.fillStyle = bgcolor;\n"
"					context.fillRect(X, Y, Width, BoxHeight);\n"
"					context.fillStyle = Color;\n"
...
"			context.stroke();\n"
"		}\n"
"		// SpinnerDraw(context, SpinnerLarge, 0, 0,  400, 400 );\n"
"		// SpinnerDraw(context, SpinnerLarge2, 400, 0,  400, 400 );\n"
"		// SpinnerDraw(context, SpinnerSmall, 450, 450,  20, 20 );\n"
"		SpinnerDraw(SpinnerShow(), context, SpinnerSmall, 0, nHeight-20,  20, 20);\n"
"		// if(SymbolState)\n"
"		// {\n"
"		// 	var s = SymbolState.s;\n"
"		// 	if()\n"
...
"		if((!ReferenceGraph <= 0) && (!ReferenceGraph>=0))\n"
"		{\n"
"			debugger;\n"
"		}\n"
...
"		CounterValueWidth = Math.max(Counte";
...
"rValueWidth, T.formatted.length * (FontWidth+1));\n"
"	}\n"
"\n"
"}\n"
"\n"
...
"	var InputActive = SubMenuActive == SubMenuTimers || SubMenuActive == SubMenuGroup || SubMenuActive == SubMenuFunctions;\n"
"	if(!InputActive)\n"
"	{\n"
"		if(k == 220)\n"
"		{\n"
